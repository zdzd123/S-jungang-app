...
public class OriginatorInfoOrderController {
    ...
    @Transactional
    public ResultWrapper<HashMap<String, String>> pay() {
        ...
        try {
            ...
            // init
            OriginatorInfoOrder originatorInfoOrder = new OriginatorInfoOrder();
            ...
            WeiXinData wxData = WeiXinPayUtil.makePreOrder(WeiXinTradeType.JSAPI, openid, product_id,
                    out_trade_no, subject, amount.doubleValue(), ip, notify_url);
            // 订单失败
    ...
    public String weixinNotifyUrl(HttpServletRequest request) {
        ...
        if (originatorInfoOrder.getOrderAmount().compareTo(totaAmount) != 0) {
    ...
    @ApiOperation(value = "查询合伙人订单", notes = "查询合伙人")
