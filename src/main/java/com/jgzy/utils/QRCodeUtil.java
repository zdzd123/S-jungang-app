...
//        Image src1 = Toolkit.getDefaultToolkit().getImage(new File(myImagePath).getPath());
    ...
    public static String getImageStream(String imgPath){
        ...
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                OutputStream outputStream = new FileOutputStream(new File(imageFilePath));
                int len;
                //实例化存储字节数组
            ...
            System.out.println("获取网络图片出现异常，图片路径为：" + imgPath);
            e.printStackTrace();
        }
    ...
    public static String decode(File file) throws Exception {
        ...
        MyLuminanceSource source = new MyLuminanceSource(
                image);
