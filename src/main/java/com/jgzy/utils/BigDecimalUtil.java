...
public class BigDecimalUtil {
    ...
    public static BigDecimal div(BigDecimal v1, double v2) {
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return v1.divide(b2, 2, BigDecimal.ROUND_HALF_UP);//四舍五入,保留2位小数
        //除不尽的情况
    }
     ...
     * @return
     */
    public static BigDecimal div(double v1, BigDecimal v2) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        return b1.divide(v2, 2, BigDecimal.ROUND_HALF_UP);//四舍五入,保留2位小数
        //除不尽的情况
    }
}