...
public class MyLuminanceSource extends LuminanceSource {
    ...
    public MyLuminanceSource(BufferedImage image) {
        this(image, 0, 0, image.getWidth(), image.getHeight());
    }

    public MyLuminanceSource(BufferedImage image, int left,
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {
        return new MyLuminanceSource(image, this.left + left,
    ...
    public LuminanceSource rotateCounterClockwise() {
        ...
        g.dispose();
        int width = getWidth();
        return new MyLuminanceSource(rotatedImage, top,
